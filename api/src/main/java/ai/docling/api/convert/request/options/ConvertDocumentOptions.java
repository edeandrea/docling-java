...
public record ConvertDocumentOptions(
    ...
    @JsonProperty("from_formats") @Nullable List<InputFormat> fromFormats,

    @JsonProperty("to_formats") @Nullable List<OutputFormat> toFormats,

    @JsonProperty("image_export_mode") @Nullable ImageRefMode imageExportMode,

    @JsonProperty("do_ocr") @Nullable Boolean doOcr,

    @JsonProperty("force_ocr") @Nullable Boolean forceOcr,

    @JsonProperty("ocr_engine") @Nullable OcrEngine ocrEngine,

    @JsonProperty("ocr_lang") @Nullable List<String> ocrLang,

    @JsonProperty("pdf_backend") @Nullable PdfBackend pdfBackend,

    @JsonProperty("table_mode") @Nullable TableFormerMode tableMode,

    @JsonProperty("table_cell_matching") @Nullable Boolean tableCellMatching,

    @JsonProperty("pipeline") @Nullable ProcessingPipeline pipeline,

    @JsonProperty("page_range") @Nullable Integer @Nullable [] pageRange,

    @JsonProperty("document_timeout") @Nullable Duration documentTimeout,

    @JsonProperty("abort_on_error") @Nullable Boolean abortOnError,

    @JsonProperty("do_table_structure") @Nullable Boolean doTableStructure,

    @JsonProperty("include_images") @Nullable Boolean includeImages,

    @JsonProperty("images_scale") @Nullable Double imagesScale,

    @JsonProperty("md_page_break_placeholder") @Nullable String mdPageBreakPlaceholder,

    @JsonProperty("do_code_enrichment") @Nullable Boolean doCodeEnrichment,

    @JsonProperty("do_formula_enrichment") @Nullable Boolean doFormulaEnrichment,

    @JsonProperty("do_picture_classification") @Nullable Boolean doPictureClassification,

    @JsonProperty("do_picture_description") @Nullable Boolean doPictureDescription,

    @JsonProperty("picture_description_area_threshold") @Nullable Double pictureDescriptionAreaThreshold,

    @JsonProperty("picture_description_local") @Nullable PictureDescriptionLocal pictureDescriptionLocal,

    @JsonProperty("picture_description_api") @Nullable PictureDescriptionApi pictureDescriptionApi,

    @JsonProperty("vlm_pipeline_model") @Nullable VlmModelType vlmPipelineModel,

    @JsonProperty("vlm_pipeline_model_local") @Nullable String vlmPipelineModelLocal,

    @JsonProperty("vlm_pipeline_model_api") @Nullable String vlmPipelineModelApi
  ...
  public static class Builder {
    ...
    @Nullable
    private Integer @Nullable [] pageRange;
    @Nullable
