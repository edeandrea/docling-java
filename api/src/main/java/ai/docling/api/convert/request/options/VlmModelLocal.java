...
public record VlmModelLocal(
    ...
    @JsonProperty("inference_framework") InferenceFramework inferenceFramework,

    @JsonProperty("transformers_model_type") @Nullable TransformersModelType transformersModelType,

    @JsonProperty("extra_generation_config") @Nullable Map<String, Object> extraGenerationConfig
  ...
  public VlmModelLocal {
    ...
    if (inferenceFramework == null) {
      throw new IllegalArgumentException("inferenceFramework cannot be null");
    }
  ...
  public static class Builder {
     ...
     */
    public Builder transformersModelType(@Nullable TransformersModelType transformersModelType) {
     ...
     */
    public Builder extraGenerationConfig(@Nullable Map<String, Object> extraGenerationConfig) {
