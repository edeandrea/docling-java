...
public class ClearResponse {
   ...
   *
   * @param status the status message, or null if not provided
  ...
  /**
   * Builder for creating {@link ClearResponse} instances.
   * Generated by Lombok's {@code @Builder} annotation.
   * 
   * <p>Builder methods:
   * <ul>
   *   <li>{@code status(String)} - Set the status message</li>
   * </ul>
   */
