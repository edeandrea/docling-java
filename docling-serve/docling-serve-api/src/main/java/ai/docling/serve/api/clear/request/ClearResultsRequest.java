...
public class ClearResultsRequest {
  ...
  /**
   * The duration threshold after which data is considered stale and eligible for cleanup.
   *
   * @param olderThen the age threshold duration
   * @return the age threshold duration
   */
  @lombok.NonNull
  ...
  /**
   * Builder for creating {@link ClearResultsRequest} instances.
   * Generated by Lombok's {@code @Builder} annotation.
   * 
   * <p>Builder methods:
   * <ul>
   *   <li>{@code olderThen(Duration)} - Set the age threshold duration</li>
   * </ul>
   */
  public static class ClearResultsRequestBuilder { }
}
